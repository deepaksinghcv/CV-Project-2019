...
dfs={'imWidth',32, 'gtWidth',16, 'nOrients',8, 'nDists',15, ...
  ...
  'seed',1, 'calibrate',1, 'useParfor',1, 'cacheDir','/home/ashishmenon/labpc/oef/cache/', ...
  'modelFnm','model', 'bsdsDir','/home/ashishmenon/labpc/oef/BSDS500/data/'};
...
fprintf('/n-------------------------------------------/n');
fprintf('Training tree %d of %d/n',treeInd,opts.nTrees); tStart=clock;
...
fprintf('Training of tree %d complete (time=%.1fs)',treeInd,e);
